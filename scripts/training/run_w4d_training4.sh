...
experiment_name=training_w4d_agent_3mode_all_navtrain_simple_ar_wm_wo_arloss_wo_cmdpred
...
python $NAVSIM_DEVKIT_ROOT/navsim/planning/script/run_training.py \
    ...
    agent.config.model_version=11 \
    agent.config.use_ar=True \
    agent.config.use_ar_wm=True \
    agent.config.num_mode=4 \
    resume_ckpt_path="'/mnt/parallel_ssd/home/zdhs0121/Driving/navsim_workspace/world4drive/exp/training_w4d_agent_3mode_all_navtrain_simple_ar_wm_wo_arloss_wo_cmdpred/2025.10.23.18.15.17/lightning_logs/version_0/checkpoints/epoch=64-step=26260.ckpt'"
