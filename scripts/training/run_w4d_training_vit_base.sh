...
experiment_name=training_w4d_agent_4mode_navtrain_all_vit_geometry/512_100_epoch_lr3e_4_vit_base
...
torchrun \
    ...
    agent.config.model_version='vit_base_geometry_no_refine' \
