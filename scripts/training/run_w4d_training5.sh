...
experiment_name=training_w4d_agent_3mode_all_navtrain_simple_ar_v3_wo_cmdpred
...
python $NAVSIM_DEVKIT_ROOT/navsim/planning/script/run_training.py \
    ...
    agent.config.model_version=10 \
    agent.config.use_ar=True \
    agent.config.num_mode=4 \
    resume_ckpt_path="'/mnt/parallel_ssd/home/zdhs0121/Driving/navsim_workspace/world4drive/exp/training_w4d_agent_3mode_all_navtrain_simple_ar_v3_wo_cmdpred/2025.10.18.20.28.00/lightning_logs/version_0/checkpoints/epoch=44-step=18180.ckpt'"
