...
experiment_name=training_w4d_agent_4mode_navtrain_all_dino_geometry_only/256_50_epoch_lr3e_4_geometry_only_dino_small
...
torchrun \
    ...
    agent.config.model_version='dino_small_geometry_only' \
