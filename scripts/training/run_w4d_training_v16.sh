...
experiment_name=training_w4d_agent_4mode_navtrain_all_v16_geometry_fusion/bs512
...
torchrun \
    ...
    cache_path=$NAVSIM_EXP_ROOT/dino_geometry_cache_trainval_single_view \
    agent.config.model_version=16 \
