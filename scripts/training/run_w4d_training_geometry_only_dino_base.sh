...
experiment_name=training_w4d_agent_4mode_navtrain_all_dino_geometry_only/256_50_epoch_lr3e_4_geometry_only_dino_base
...
torchrun \
    ...
    agent.config.model_version='dino_base_geometry_only' \
