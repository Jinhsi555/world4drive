...
experiment_name=training_w4d_agent_4mode_navtrain_all_dino_geometry_only/256_50_epoch_lr3e_4_wm_post_training_dino_base
...
torchrun \
    ...
    agent.checkpoint_path="'/vepfs-mlp2/c20250502/haoce/wlb/world4drive/exp/training_w4d_agent_4mode_navtrain_all_dino_geometry_only/256_50_epoch_lr3e_4_geometry_only_dino_base/2026.02.19.10.37.16/lightning_logs/version_0/checkpoints/epoch=49-step=20200.ckpt'" \
    agent.config.model_version='dino_base_wm_post_training' \
