...
navtrain_score_path="/mnt/parallel_ssd/home/zdhs0121/Driving/navsim_workspace/Epona/exp"
# 运行Python脚本
python ${NAVSIM_DEVKIT_ROOT}/navsim/planning/script/run_pdm_score_v1_voc_save_info.py \
    experiment_name=${experiment_name} \
    +cache_path=null \
    metric_cache_path=${metric_cache_path} \
    train_test_split=navtrain \
    +traj_vocab_path=${traj_vocab_path} \
    +navtrain_score_path=${navhard_score_path}