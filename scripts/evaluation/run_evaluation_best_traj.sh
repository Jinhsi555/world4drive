...
dir=training_w4d_agent_diff_cmd/best_traj_eval
metric_cache_path="${NAVSIM_EXP_ROOT}/metric_cache_${split}_two_stage"
cd ${NAVSIM_DEVKIT_ROOT}
ckpt_dir=/mnt/parallel_ssd/home/zdhs0121/Driving/navsim_workspace/world4drive/exp/training_w4d_agent_diff_cmd/2025.10.02.23.00.37/lightning_logs/version_0/checkpoints
