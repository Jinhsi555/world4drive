...
dir=training_w4d_agent_3mode_cmdpred_temp_1frame/navtest_eval
metric_cache_path="${NAVSIM_EXP_ROOT}/metric_cache"
cd ${NAVSIM_DEVKIT_ROOT}
ckpt_dir=/mnt/parallel_ssd/home/zdhs0121/Driving/navsim_workspace/world4drive/exp/training_w4d_agent_3mode_cmdpred_temp_1frame/2025.10.14.23.35.38/lightning_logs/version_0/checkpoints
# 并行相关配置 (可通过环境变量覆盖)
...
launch_eval() {
  ...
  (
      ...
      python ${NAVSIM_DEVKIT_ROOT}/navsim/planning/script/run_pdm_score_gpu_navtest_v2.py \
          agent=$agent \
