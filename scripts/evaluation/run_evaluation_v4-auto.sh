...
dir=training_w4d_agent_3mode/navtest_eval_one_stage_new1
metric_cache_path="${NAVSIM_EXP_ROOT}/metric_cache"
cd ${NAVSIM_DEVKIT_ROOT}
ckpt_dir=/vepfs-mlp2/c20250502/haoce/wlb/world4drive/exp/training_w4d_agent_3mode/2026.01.13.05.13.18/lightning_logs/version_0/checkpoints
