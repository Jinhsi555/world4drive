...
dir=training_w4d_agent_3mode_all_navtrain_simple_ar/navtest_eval_one_stage
metric_cache_path="${NAVSIM_EXP_ROOT}/metric_cache"
cd ${NAVSIM_DEVKIT_ROOT}
ckpt_dir=/mnt/parallel_ssd/home/zdhs0121/Driving/navsim_workspace/world4drive/exp/training_w4d_agent_3mode_all_navtrain_simple_ar/2025.10.17.20.17.20/lightning_logs/version_0/checkpoints
