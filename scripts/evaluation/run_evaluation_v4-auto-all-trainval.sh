...
dir=training_w4d_agent_4mode_navtrain_all_v15_dino_vision_query/single_view_use_wm/navtest_eval_one_stage_train_all
metric_cache_path="${NAVSIM_EXP_ROOT}/metric_cache"
cd ${NAVSIM_DEVKIT_ROOT}
ckpt_dir=/vepfs-mlp2/c20250502/haoce/wlb/world4drive/exp/training_w4d_agent_4mode_navtrain_all_v15_dino_vision_query/single_view_use_wm/2026.01.27.07.44.27/lightning_logs/version_0/checkpoints
...
launch_eval() {
  ...
  (
      ...
      python ${NAVSIM_DEVKIT_ROOT}/navsim/planning/script/run_pdm_score_one_stage_gpu.py \
          ...
          agent.config.model_version='single_view' \
          agent.config.num_mode=4 \
          agent.config.use_wm=True \
          +agent.config.avg_mode=False \
