...
dir=training_w4d_agent_4mode_navtrain_all_v15_dino_vision_query/3_views_refine_temporal_wm/navtest_eval_one_stage_train_all_auto_regressive
metric_cache_path="${NAVSIM_EXP_ROOT}/metric_cache"
cd ${NAVSIM_DEVKIT_ROOT}
ckpt_dir=/vepfs-mlp2/c20250502/haoce/wlb/world4drive/exp/training_w4d_agent_4mode_navtrain_all_v15_dino_vision_query/3_views_refine_temporal_wm/2026.01.28.22.10.02/lightning_logs/version_0/checkpoints
