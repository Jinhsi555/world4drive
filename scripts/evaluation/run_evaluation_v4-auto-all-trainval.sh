...
dir=training_w4d_agent_4mode_navtrain_all_dino_geometry_ablation/ablation3_with_wm_ego_status/navtest_eval_one_stage_train_all_first
metric_cache_path="${NAVSIM_EXP_ROOT}/metric_cache"
cd ${NAVSIM_DEVKIT_ROOT}
ckpt_dir=/vepfs-mlp2/c20250502/haoce/wlb/world4drive/exp/training_w4d_agent_4mode_navtrain_all_dino_geometry_ablation/ablation3_with_wm_ego_status/2026.02.24.18.07.36/lightning_logs/version_0/checkpoints
...
launch_eval() {
  ...
  (
      ...
      python ${NAVSIM_DEVKIT_ROOT}/navsim/planning/script/run_pdm_score_one_stage_gpu.py \
          ...
          agent.config.model_version='ablation3' \
