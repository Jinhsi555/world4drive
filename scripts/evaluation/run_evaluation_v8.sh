...
dir=training_w4d_agent_3mode_all_navtrain_simple_ar_wm/navtest_eval_one_stage
metric_cache_path="${NAVSIM_EXP_ROOT}/metric_cache"
cd ${NAVSIM_DEVKIT_ROOT}
ckpt_dir=/mnt/parallel_ssd/home/zdhs0121/Driving/navsim_workspace/world4drive/exp/training_w4d_agent_3mode_all_navtrain_simple_ar_wm/2025.10.18.20.23.03/lightning_logs/version_0/checkpoints
