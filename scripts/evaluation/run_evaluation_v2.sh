...
dir=training_w4d_agent_3mode_cmdpred_temp_2frame
metric_cache_path="${NAVSIM_EXP_ROOT}/metric_cache_${split}_two_stage"
cd ${NAVSIM_DEVKIT_ROOT}
ckpt_dir=/mnt/parallel_ssd/home/zdhs0121/Driving/navsim_workspace/world4drive/exp/training_w4d_agent_3mode_cmdpred_temp_2frame/2025.10.14.23.29.58/lightning_logs/version_0/checkpoints
# 并行相关配置 (可通过环境变量覆盖)
