...
dir=training_w4d_agent_4mode_all_navtrain_ar_4chunk_wm_temp_ensemble/navtest_eval_one_stage
metric_cache_path="${NAVSIM_EXP_ROOT}/metric_cache"
cd ${NAVSIM_DEVKIT_ROOT}
ckpt_dir=/mnt/parallel_ssd/home/zdhs0121/Driving/navsim_workspace/world4drive/exp/training_w4d_agent_4mode_all_navtrain_ar_4chunk_wm_temp_ensemble/2025.11.09.21.10.33/lightning_logs/version_0/checkpoints
