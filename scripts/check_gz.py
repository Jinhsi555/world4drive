...
# 设置检查的目录和输出文件路径
base_dir = '/vepfs-mlp2/c20250502/haoce/wlb/world4drive/exp/dino_geometry_cache_test_single_view_float32/feature_cache'
output_file = 'dino_geometry_cache_test_single_view_float32_corrupted_files.json'
