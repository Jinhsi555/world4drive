...
for token in tqdm(tokens):
    ...
    # 将8个步的相对轨迹拆分成单步轨迹
    for step_idx in range(full_8_step_traj.shape[0]):
        step_traj = full_8_step_traj[step_idx:step_idx+1, :].numpy()  # (1, 3)
...
np.save('/mnt/parallel_ssd/home/zdhs0121/Driving/navsim_workspace/world4drive/exp/navsim_abs_single_step_traj_2048.npy', step_trajs)
...
output_path = Path('/mnt/parallel_ssd/home/zdhs0121/Driving/navsim_workspace/world4drive/exp/kmeans_navsim_abs_single_step_traj_2048.npy')
