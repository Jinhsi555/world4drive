...
class W4DModel(nn.Module):
    ...
    def forward_test(self, features) -> Dict[str, torch.Tensor]:
        ...
        ## 只使用车辆运动信息
        status_feature_dynamic = status_feature[..., 4:]  # [bs, 4] 
        ...
        # =============================== keyval trans =======================================
        status_encoding = self._status_encoding(status_feature_dynamic)  # [bs, 256]
    ...
    def forward_train(self, features) -> Dict[str, torch.Tensor]:
        ...
        # =============================== keyval trans=======================================
        status_encoding = self._status_encoding(status_feature_dynamic)
